...
def sample_from_model(model, x_0, nfes=[1, 5, 10, 25, 50, 100]):
    ...
    for nfe in nfes:
        ...
        #     "step_size": 1./nfe,
        # })[-1]        
        fake_image = odeint(model, x_0, t, method="euler", options={
            "step_size": 1./nfe,
        })[-1]
    ...
    for epoch in range(init_epoch, args.num_epoch+1):
        ...
        if rank == 0:
            ...
            for nfe in fake_samples.keys():
                torchvision.utils.save_image(fake_samples[nfe], os.path.join(
                    exp_path, f'sample_epoch_{epoch}_{nfe}.png'), normalize=True)
...
if __name__ == '__main__':
    ...
    if size > 1:
        ...
        for rank in range(size):
            ...
            print(
                f'Node rank {args.node_rank}, local proc {rank}, global proc {global_rank}' 
            )
